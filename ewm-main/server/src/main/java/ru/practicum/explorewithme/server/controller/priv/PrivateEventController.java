...
public class PrivateEventController {
    ...
    public EventFullDto create(@PathVariable @Positive Long userId,
        ...
        log.info("[PrivateEventController] POST /users/{}/events - создание события: {}", userId, newEvent.getTitle());
        EventFullDto createdEvent = eventServiceImpl.create(userId, newEvent);
        log.info("[PrivateEventController] Событие создано: id={}, title={}", createdEvent.getId(), createdEvent.getTitle());
        return createdEvent;
    }
    ...
    public EventFullDto getById(@PathVariable @Positive Long userId,
        ...
        log.debug("[PrivateEventController] Событие найдено: id={}, title={}, state={}", eventId, event.getTitle(), event.getState());
        return event;
    }
    ...
    public EventFullDto update(@PathVariable @Positive Long userId,
        ...
        log.info("[PrivateEventController] Событие обновлено: id={}, newState={}", eventId, updatedEvent.getState());
        return updatedEvent;
    }
