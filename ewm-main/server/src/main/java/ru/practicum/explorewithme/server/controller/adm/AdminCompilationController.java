...
public class AdminCompilationController {
    ...
    public ResponseEntity<CompilationDto> create(@Valid @RequestBody NewCompilationDto newCompilation) {
        ...
        log.info("[AdminCompilationController] Подборка создана: id={}, title={}", created.getId(), created.getTitle());
    ...
    public ResponseEntity<List<CompilationDto>> getAll(@RequestParam(required = false) Boolean pinned,
        ...
        log.info("[AdminCompilationController] GET /admin/compilations?pinned={}&from={}&size={}", pinned, from, size);
    ...
    public CompilationDto update(@PathVariable @Positive Long compId,
        ...
        log.info("[AdminCompilationController] Подборка обновлена: id={}, title={}", compId, updated.getTitle());
        return updated;
    }
}
